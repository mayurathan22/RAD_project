...
<div class="container">
  ...
  border-right-color: rgba(60,60,60,.4); opacity:0.8">
                <div class="card-header" style="color:white;margin-left:10px;margin-bottom: 10px;font-size: 20px"> {{ isset($url) ? ucwords($url) : ""}} {{ __('Register') }}</div>
                ...
                @isset($url)
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right" style="color:white;margin-left:10px;margin-bottom: 10px;font-size: 20px">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right" style="color:white;margin-left:10px;margin-bottom: 10px;font-size: 20px">{{ __('Confirm Password') }}</label>
